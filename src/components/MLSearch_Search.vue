  ...
  <div class="search-wrapper">
    ...
    <el-form ref="form" :model="form" label-width="80px" label-position="left">
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" class="search-item">
          <el-form-item label="检索来源">
            <el-select v-model="form.searchresource" placeholder="请输入检索来源" class="single-selector">
      ...
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="9" class="search-item time-selector">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="9" class="search-item">
